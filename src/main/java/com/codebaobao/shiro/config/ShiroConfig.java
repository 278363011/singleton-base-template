package com.codebaobao.shiro.config;

import com.codebaobao.shiro.filter.SessionControlFilter;
import com.codebaobao.shiro.filter.UrlPermissionControlFilter;
import com.codebaobao.shiro.manager.CustomSessionManager;
import com.codebaobao.shiro.modular.CustomModularRealmAuthenticator;
import com.codebaobao.shiro.realm.WxRealm;
import com.codebaobao.shiro.utils.ShiroKit;
import com.codebaobao.shiro.realm.AdminRealm;
import lombok.Data;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        //测试3
        filterChainDefinitionMap.put("/sys/test3", "authc");

        // 所有url都必须认证通过才可以访问
        filterChainDefinitionMap.put("/**", "kickout");

        //下面的配置路径 都需要在上面配置 authc 否则访问不到filter
        filterChainDefinitionMap.put("/sys/test3","requestURL");
